...
set /p choice="Enter the number corresponding to the file you want to launch in 64Debugger: "
...
start cmd /k "tools\C64Debugger\C64Debugger c64-code\!filename!.prg"
